      ...
      const submitButton = document.getElementById("project-contact-us-button");
      ...
      form.addEventListener("submit", async function (e) {        
        ...
        try {
          ...
          const currentDate = new Date().toISOString().split('T')[0]; // "2025-07-29"
          formDataObj['Date'] = currentDate;
          ...
          // Submit form data
          const scriptURL =
            "https://script.google.com/macros/s/AKfycbw268ZMrg3ZPSRYl4OQNUUKWywlPvGGzfxwYl9-uvtxIlkY6dV71Nyj-1cBCnyCN2N-LQ/exec";
